...
Pass a `locale` option when initialising Swagger UI.  Register translations via the plugin API **before** or **after** initialisation:
...
// Register French translations at any time
